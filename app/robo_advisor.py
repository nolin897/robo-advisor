...
try: # Found try/except Error syntax via https://www.jquery-az.com/python-keyerror-handle-3-examples/    
    for symbol in selected_symbols:    
        ...
        # ANNUALIZED EXPECTED RETURN, ANNUALIZED VOLATILITY, & SHARPE RATIO (BASED ON PRIOR COURSEWORK)
    ...
    print(f"{symbol.upper()} INVALID: Please re-run the script with a valid stock symbol to get your investment recommendation!")
